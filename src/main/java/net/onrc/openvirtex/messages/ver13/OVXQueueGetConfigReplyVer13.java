...
public class OVXQueueGetConfigReplyVer13 extends OFQueueGetConfigReplyVer13 implements OVXQueueGetConfigReply {

   

    protected OVXQueueGetConfigReplyVer13(long xid, OFPort port,
