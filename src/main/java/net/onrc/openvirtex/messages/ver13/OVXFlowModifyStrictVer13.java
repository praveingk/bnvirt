...
public class OVXFlowModifyStrictVer13 extends OFFlowModifyStrictVer13 implements OVXFlowModifyStrict {

   

    protected OVXFlowModifyStrictVer13(
            long xid,
            U64 cookie,
            U64 cookieMask,
            TableId tableId,
    ...
    private final Logger log = LogManager.getLogger(OVXFlowModifyStrictVer13.class.getName());
