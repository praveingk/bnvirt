...
public class OVXFlowDeleteVer13 extends OFFlowDeleteVer13 implements OVXFlowDelete {

   

    protected OVXFlowDeleteVer13(
            long xid,
            U64 cookie,
            U64 cookieMask,
            TableId tableId,
    ...
    public OVXFlowMod clone() {
        ...
        if (OVXFactoryInst.ofversion == 10) {
            flowMod = OVXFactoryInst.myOVXFactory.buildOVXFlowDelete(this.getXid(), this.getMatch(), this.getCookie(), this.getIdleTimeout(), this.getHardTimeout(), this.getPriority(), this.getBufferId(), this.getOutPort(), this.getFlags(), this.getActions());
        } else {
            flowMod = OVXFactoryInst.myOVXFactory.buildOVXFlowDelete(this.getXid(), this.getCookie(), this.getCookieMask(), this.getTableId(), this.getIdleTimeout(), this.getHardTimeout(), this.getPriority(), this.getBufferId(), this.getOutPort(), this.getOutGroup(), this.getFlags(), this.getMatch(), this.getInstructions());
        }
        return flowMod;
    }
