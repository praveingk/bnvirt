...
public class OVXActionTransportLayerDestinationVer10 extends
        OFActionSetTpDstVer10 implements OVXActionTransportLayerDestination {

    public OVXActionTransportLayerDestinationVer10(TransportPort tpPort) {
		super(tpPort);
