...
import org.projectfloodlight.openflow.protocol.ver10.OFActionSetDlDstVer10;
import org.projectfloodlight.openflow.types.MacAddress;

/**
 * Virtual destination data layer action message.
 */
public class OVXActionDataLayerDestinationVer10 extends OFActionSetDlDstVer10
        implements OVXActionDataLayerDestination {

    public OVXActionDataLayerDestinationVer10(MacAddress dlAddr) {
		super(dlAddr);
    ...
    public void virtualize(final OVXSwitch sw,
        ...
        try {
            ...
            throw new ActionVirtualizationDenied("Target mac " + mac
                    + " is invalid ", OFBadActionCode.EPERM);
        }
