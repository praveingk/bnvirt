...
public class OVXFlowModifyVer10 extends OFFlowModifyVer10 implements OVXFlowModify {

   

    protected OVXFlowModifyVer10(
			long xid,
			Match match,
			U64 cookie,
			int idleTimeout,
    ...
    private final Logger log = LogManager.getLogger(OVXFlowModifyVer10.class.getName());
