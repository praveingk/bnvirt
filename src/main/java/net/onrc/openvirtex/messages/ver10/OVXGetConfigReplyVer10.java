...
public class OVXGetConfigReplyVer10 extends OFGetConfigReplyVer10 implements OVXGetConfigReply {

   

    protected OVXGetConfigReplyVer10(long xid, Set<OFConfigFlags> flags,
			int missSendLen) {
