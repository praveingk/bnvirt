...
public class OVXQueueGetConfigRequestVer10 extends OFQueueGetConfigRequestVer10 implements OVXQueueGetConfigRequest {

   
    protected OVXQueueGetConfigRequestVer10(long xid, OFPort port) {
		super(xid, port);
