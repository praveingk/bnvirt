...
public class OVXFlowDeleteVer10 extends OFFlowDeleteVer10 implements OVXFlowDelete {

   

    protected OVXFlowDeleteVer10(
			long xid,
			Match match,
			U64 cookie,
			int idleTimeout,
    ...
    private final Logger log = LogManager.getLogger(OVXFlowDeleteVer10.class.getName());
