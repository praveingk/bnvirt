...
public class OVXPortStatusVer10 extends OFPortStatusVer10 implements OVXPortStatus {

   
    protected OVXPortStatusVer10(long xid, OFPortReason reason, OFPortDesc desc) {
    ...
    public boolean isState(OFPortState state) {
        return this.desc.getState().contains(state);
    }
