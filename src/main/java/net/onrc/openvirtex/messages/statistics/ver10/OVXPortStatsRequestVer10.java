 ...
 */
public class OVXPortStatsRequestVer10 extends OFPortStatsRequestVer10 implements
     OVXPortStatsRequest {
    ...
    public void devirtualize(final OVXSwitch sw) {
        ...
        if (this.getPortNo() == OFPort.ANY) {
            ...
            OVXPortStatsReply rep =(OVXPortStatsReply) new OVXPortStatsReplyVer10(this.getXid(),DEFAULT_FLAGS,entries);
