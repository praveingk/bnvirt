 ...
 */
public class OVXDescStatsRequestVer13 extends OFDescStatsRequestVer13 implements
        OVXDescStatsRequest {

    public OVXDescStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags) {
		super(xid, flags);
    ...
    public void devirtualize(final OVXSwitch sw)
    	...
    	final OVXDescStatsReply reply=OVXFactoryInst.myOVXFactory.buildOVXDescStatsReply(this.getXid(), DEFAULT_FLAGS, "BNV", "virtual hardware", OpenVirteX.VERSION,sw.getSwitchName(),OVXSwitch.DPDESCSTRING);
