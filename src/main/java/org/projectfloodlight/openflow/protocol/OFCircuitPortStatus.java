...
public interface OFCircuitPortStatus extends OFObject, OFExperimenter {
    ...
    public interface Builder extends OFExperimenter.Builder {
        ...
        int getLengths();
        Builder setLengths(int lengths);
        MacAddress getHwAddr();
