...
public class OFPortDescStatsReplyVer13 implements OFPortDescStatsReply {
...
//
   ...
   protected OFPortDescStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFPortDesc> entries) {
        if(flags == null) {
