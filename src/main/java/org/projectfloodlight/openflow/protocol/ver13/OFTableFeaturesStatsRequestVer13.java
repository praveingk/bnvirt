...
public class OFTableFeaturesStatsRequestVer13 implements OFTableFeaturesStatsRequest {
...
//
    ...
    protected OFTableFeaturesStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags, List<OFTableFeatures> entries) {
        if(flags == null) {
