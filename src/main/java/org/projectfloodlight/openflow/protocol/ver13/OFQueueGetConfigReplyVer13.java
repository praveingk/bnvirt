...
public class OFQueueGetConfigReplyVer13 implements OFQueueGetConfigReply {
...
//
    ...
    protected OFQueueGetConfigReplyVer13(long xid, OFPort port, List<OFPacketQueue> queues) {
        if(port == null) {
