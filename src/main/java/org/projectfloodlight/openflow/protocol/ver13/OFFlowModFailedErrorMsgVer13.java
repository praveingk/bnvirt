...
public class OFFlowModFailedErrorMsgVer13 implements OFFlowModFailedErrorMsg {
...
//
    ...
    protected OFFlowModFailedErrorMsgVer13(long xid, OFFlowModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
