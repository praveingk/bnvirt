...
public class OFPortStatsRequestVer13 implements OFPortStatsRequest {
...
//
    ...
    protected OFPortStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags, OFPort portNo) {
        if(flags == null) {
