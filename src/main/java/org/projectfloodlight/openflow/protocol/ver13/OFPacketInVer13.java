...
public class OFPacketInVer13 implements OFPacketIn {
    ...
    public final static int MINIMUM_LENGTH = 34;

        public final static long DEFAULT_XID = 0x0L;
...
//
    ...
    protected OFPacketInVer13(long xid, OFBufferId bufferId, int totalLen, OFPacketInReason reason, TableId tableId, U64 cookie, Match match, byte[] data) {
        if(bufferId == null) {
    ...
    @Override
    public OFPort getInPort()throws UnsupportedOperationException {
        return this.match.get(MatchField.IN_PORT);
    }
    ...
    @Override
    public OFPort getInPhyPort()throws UnsupportedOperationException {
        return this.match.get(MatchField.IN_PHY_PORT);
    }
