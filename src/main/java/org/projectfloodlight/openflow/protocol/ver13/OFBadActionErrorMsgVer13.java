...
public class OFBadActionErrorMsgVer13 implements OFBadActionErrorMsg {
...
//
    ...
    protected OFBadActionErrorMsgVer13(long xid, OFBadActionCode code, OFErrorCauseData data) {
        if(code == null) {
