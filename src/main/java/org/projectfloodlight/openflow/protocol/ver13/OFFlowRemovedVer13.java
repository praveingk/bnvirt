...
public class OFFlowRemovedVer13 implements OFFlowRemoved {
...
//
    ...
    protected OFFlowRemovedVer13(long xid, U64 cookie, int priority, short reason, TableId tableId, long durationSec, long durationNsec, int idleTimeout, int hardTimeout, U64 packetCount, U64 byteCount, Match match) {
        if(cookie == null) {
