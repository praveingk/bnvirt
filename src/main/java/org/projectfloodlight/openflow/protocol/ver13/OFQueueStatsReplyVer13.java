...
public class OFQueueStatsReplyVer13 implements OFQueueStatsReply {
...
//
    ...
    protected OFQueueStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFQueueStatsEntry> entries) {
        if(flags == null) {
