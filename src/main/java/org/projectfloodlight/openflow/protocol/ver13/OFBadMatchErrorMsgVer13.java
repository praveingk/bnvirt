...
public class OFBadMatchErrorMsgVer13 implements OFBadMatchErrorMsg {
...
//
    ...
    protected OFBadMatchErrorMsgVer13(long xid, OFBadMatchCode code, OFErrorCauseData data) {
        if(code == null) {
