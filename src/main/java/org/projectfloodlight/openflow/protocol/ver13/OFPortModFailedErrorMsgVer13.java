...
public class OFPortModFailedErrorMsgVer13 implements OFPortModFailedErrorMsg {
...
//
    ...
    protected OFPortModFailedErrorMsgVer13(long xid, OFPortModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
