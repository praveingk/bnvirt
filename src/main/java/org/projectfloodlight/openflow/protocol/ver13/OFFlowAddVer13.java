...
public class OFFlowAddVer13 implements OFFlowAdd {
...
//
    ...
    protected OFFlowAddVer13(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
            throw new NullPointerException("OFFlowAddVer13: property cookie cannot be null");
        }
        if(cookieMask == null) {
            cookieMask = U64.NO_MASK;
        }
        if(tableId == null) {
    ...
    public void setInstructions(List<OFInstruction> myInstructions) {
        this.instructions = myInstructions;
    }
