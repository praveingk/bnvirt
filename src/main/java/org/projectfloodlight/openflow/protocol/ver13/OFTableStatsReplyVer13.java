...
public class OFTableStatsReplyVer13 implements OFTableStatsReply {
...
//
    ...
    protected OFTableStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFTableStatsEntry> entries) {
        if(flags == null) {
