...
public class OFFeaturesReplyVer13 implements OFFeaturesReply {
...
//
    ...
    protected OFFeaturesReplyVer13(long xid, DatapathId datapathId, long nBuffers, short nTables, OFAuxId auxiliaryId, Set<OFCapabilities> capabilities, long reserved) {
        if(datapathId == null) {
