...
public class OFAggregateStatsReplyVer13 implements OFAggregateStatsReply {
...
//
    ...
    public OFAggregateStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, U64 packetCount, U64 byteCount, long flowCount) {
        if(flags == null) {
