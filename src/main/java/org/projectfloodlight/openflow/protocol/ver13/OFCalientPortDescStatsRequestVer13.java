...
class OFCalientPortDescStatsRequestVer13 implements OFCalientPortDescStatsRequest {
...
//
    ...
    final static OFCalientPortDescStatsRequestVer13 DEFAULT = new OFCalientPortDescStatsRequestVer13(
    ...
    static class BuilderWithParent implements OFCalientPortDescStatsRequest.Builder {
    ...
    static class Builder implements OFCalientPortDescStatsRequest.Builder {
        // OF message fields
        private boolean xidSet;
        private long xid;
        private boolean flagsSet;
...
//
    ...
    static class Reader implements OFMessageReader<OFCalientPortDescStatsRequest> {
        @Override
        public OFCalientPortDescStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFCalientPortDescStatsRequestVer13 calientPortDescStatsRequestVer13 = new OFCalientPortDescStatsRequestVer13(
                    xid,
                      flags
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", calientPortDescStatsRequestVer13);
    ...
    final static OFCalientPortDescStatsRequestVer13Funnel FUNNEL = new OFCalientPortDescStatsRequestVer13Funnel();
    static class OFCalientPortDescStatsRequestVer13Funnel implements Funnel<OFCalientPortDescStatsRequestVer13> {
    ...
    static class Writer implements OFMessageWriter<OFCalientPortDescStatsRequestVer13> {
        @Override
