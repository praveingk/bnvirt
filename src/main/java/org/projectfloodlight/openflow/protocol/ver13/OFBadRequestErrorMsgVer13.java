...
public class OFBadRequestErrorMsgVer13 implements OFBadRequestErrorMsg {
...
//
    ...
    protected OFBadRequestErrorMsgVer13(long xid, OFBadRequestCode code, OFErrorCauseData data) {
        if(code == null) {
