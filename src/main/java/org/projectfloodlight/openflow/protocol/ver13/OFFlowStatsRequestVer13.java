...
public class OFFlowStatsRequestVer13 implements OFFlowStatsRequest {
...
//
    ...
    protected OFFlowStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags, TableId tableId, OFPort outPort, OFGroup outGroup, U64 cookie, U64 cookieMask, Match match) {
        if(flags == null) {
