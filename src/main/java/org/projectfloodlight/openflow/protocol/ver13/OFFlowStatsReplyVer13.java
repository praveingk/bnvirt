...
public class OFFlowStatsReplyVer13 implements OFFlowStatsReply {
...
//
    ...
    protected OFFlowStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFFlowStatsEntry> entries) {
        if(flags == null) {
