...
class OFOxmOchSigtypeVer13 implements OFOxmOchSigtype {
...
//
    ...
    final static OFOxmOchSigtypeVer13 DEFAULT = new OFOxmOchSigtypeVer13(
        DEFAULT_VALUE
    );
    ...
    OFOxmOchSigtypeVer13(U8 value) {
        if(value == null) {
            throw new NullPointerException("OFOxmOchSigtypeVer13: property value cannot be null");
        }
        this.value = value;
    }
    ...
    static class BuilderWithParent implements OFOxmOchSigtype.Builder {
    ...
    public OFVersion getVersion() {
        ...
        public OFOxmOchSigtype build() {
                ...
                //
                return new OFOxmOchSigtypeVer13(
                    value
                );
        }
    ...
    static class Builder implements OFOxmOchSigtype.Builder {
        // OF message fields
        private boolean valueSet;
        private U8 value;
...
//
    ...
    static class Reader implements OFMessageReader<OFOxmOchSigtype> {
        @Override
        public OFOxmOchSigtype readFrom(ChannelBuffer bb) throws OFParseError {
            // fixed value property typeLen == 0x85801L
            int typeLen = bb.readInt();
            if(typeLen != 0x85801)
                throw new OFParseError("Wrong typeLen: Expected=0x85801L(0x85801L), got="+typeLen);
            U8 value = U8.of(bb.readByte());

            OFOxmOchSigtypeVer13 oxmOchSigtypeVer13 = new OFOxmOchSigtypeVer13(
                    value
                    );
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", oxmOchSigtypeVer13);
    ...
    final static OFOxmOchSigtypeVer13Funnel FUNNEL = new OFOxmOchSigtypeVer13Funnel();
    static class OFOxmOchSigtypeVer13Funnel implements Funnel<OFOxmOchSigtypeVer13> {
    ...
    static class Writer implements OFMessageWriter<OFOxmOchSigtypeVer13> {
        @Override
