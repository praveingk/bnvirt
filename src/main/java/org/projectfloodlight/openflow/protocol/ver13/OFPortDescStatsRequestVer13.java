...
public class OFPortDescStatsRequestVer13 implements OFPortDescStatsRequest {
...
//
    ...
    protected OFPortDescStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags) {
        if(flags == null) {
