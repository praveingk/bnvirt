...
class OFActionIdCircuitVer13 implements OFActionIdCircuit {
...
//
    ...
    final static OFActionIdCircuitVer13 DEFAULT = new OFActionIdCircuitVer13(

    );

    final static OFActionIdCircuitVer13 INSTANCE = new OFActionIdCircuitVer13();
    ...
    static class Reader implements OFMessageReader<OFActionIdCircuit> {
        @Override
    ...
    final static OFActionIdCircuitVer13Funnel FUNNEL = new OFActionIdCircuitVer13Funnel();
    static class OFActionIdCircuitVer13Funnel implements Funnel<OFActionIdCircuitVer13> {
    ...
    static class Writer implements OFMessageWriter<OFActionIdCircuitVer13> {
        @Override
