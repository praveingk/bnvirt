...
public class OFTableFeaturesStatsReplyVer13 implements OFTableFeaturesStatsReply {
...
//
    ...
    protected OFTableFeaturesStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFTableFeatures> entries) {
        if(flags == null) {
...
//
    ...
    static class Reader implements OFMessageReader<OFTableFeaturesStatsReply> {
        ...
        public OFTableFeaturesStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            System.out.println("Starting readFrom of table features");
            ...
            System.out.println("Creating table feature entries..");
