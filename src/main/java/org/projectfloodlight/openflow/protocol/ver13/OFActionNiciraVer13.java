        ...
        public OFActionNicira readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(subtype) {
               ...
               default:
                   ...
                   //bb.readInt();
                   //bb.readInt();
                   System.out.println( Long.toHexString(bb.readInt()));
                   System.out.println( Long.toHexString(bb.readShort()));
                   // Mostly the next sequence is going to be crap

                   System.out.println( Long.toHexString(bb.readInt()));
                   System.out.println( Long.toHexString(bb.readInt()));
                   System.out.println("Skpping bytes");
                   return null;
