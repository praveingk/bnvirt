...
class OFCalientFlowStatsRequestVer13 implements OFCalientFlowStatsRequest {
...
//
    ...
    final static OFCalientFlowStatsRequestVer13 DEFAULT = new OFCalientFlowStatsRequestVer13(
    ...
    OFCalientFlowStatsRequestVer13(long xid, Set<OFStatsRequestFlags> flags, TableId tableId, long outPort, long outGroup, U64 cookie, U64 cookieMask, Match match) {
        if(flags == null) {
    ...
    static class BuilderWithParent implements OFCalientFlowStatsRequest.Builder {
    ...
    public OFCalientFlowStatsRequest.Builder setMatch(Match match) {
        ...
        public OFCalientFlowStatsRequest build() {
                ...
                //
                return new OFCalientFlowStatsRequestVer13(
                    xid,
                    flags,
                    tableId,
                    outPort,
    ...
    static class Builder implements OFCalientFlowStatsRequest.Builder {
        // OF message fields
        private boolean xidSet;
        private long xid;
        private boolean flagsSet;
...
//
    ...
    static class Reader implements OFMessageReader<OFCalientFlowStatsRequest> {
        @Override
        public OFCalientFlowStatsRequest readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            OFCalientFlowStatsRequestVer13 calientFlowStatsRequestVer13 = new OFCalientFlowStatsRequestVer13(
                    xid,
                      flags,
                      tableId,
                      outPort,
            ...
            if(logger.isTraceEnabled())
                logger.trace("readFrom - read={}", calientFlowStatsRequestVer13);
    ...
    final static OFCalientFlowStatsRequestVer13Funnel FUNNEL = new OFCalientFlowStatsRequestVer13Funnel();
    static class OFCalientFlowStatsRequestVer13Funnel implements Funnel<OFCalientFlowStatsRequestVer13> {
    ...
    static class Writer implements OFMessageWriter<OFCalientFlowStatsRequestVer13> {
        @Override
