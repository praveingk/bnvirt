...
public class OFPortStatsReplyVer13 implements OFPortStatsReply {
...
//
    ...
    protected OFPortStatsReplyVer13(long xid, Set<OFStatsReplyFlags> flags, List<OFPortStatsEntry> entries) {
        if(flags == null) {
