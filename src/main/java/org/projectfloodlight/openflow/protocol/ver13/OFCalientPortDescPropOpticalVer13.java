...
//
    ...
    static class Reader implements OFMessageReader<OFCalientPortDescPropOptical> {
        @Override
        public OFCalientPortDescPropOptical readFrom(ChannelBuffer bb) throws OFParseError {
    ...
    static class OFCalientPortDescPropOpticalVer13Funnel implements Funnel<OFCalientPortDescPropOpticalVer13> {
        ...
        public void funnel(OFCalientPortDescPropOpticalVer13 message, PrimitiveSink sink) {
            ...
            sink.putString(message.inportPower);
            sink.putString(message.outportPower);
            // skip pad (2 bytes)
            ...
            // skip pad (4 bytes)
            sink.putString(message.inCircuitId);
            sink.putString(message.outCircuitId);
            sink.putString(message.inAlias);
            sink.putString(message.outAlias);
        }
    }
    ...
    static class Writer implements OFMessageWriter<OFCalientPortDescPropOpticalVer13> {
        @Override
        public void write(ChannelBuffer bb, OFCalientPortDescPropOpticalVer13 message) {
            // fixed value property type = 0x2
