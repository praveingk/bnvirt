...
public abstract class OFExperimenterStatsReplyVer13 {
    // version: 1.3
    ...
    static class Reader implements OFMessageReader<OFExperimenterStatsReply> {
        ...
        public OFExperimenterStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(experimenter) {
               ...
               case 0x80f958:
                   // discriminator value 0x80f958L=0x80f958L for class OFCalientStatsReplyVer13
                   return OFCalientStatsReplyVer13.READER.readFrom(bb);
               case 0x748771:
                   // discriminator value 0x748771L=0x748771L for class OFCircuitPortsReplyVer13
                   return OFCircuitPortsReplyVer13.READER.readFrom(bb);
               default:
