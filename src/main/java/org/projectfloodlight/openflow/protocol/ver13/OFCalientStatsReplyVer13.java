...
abstract class OFCalientStatsReplyVer13 {
    ...
    public final static OFCalientStatsReplyVer13.Reader READER = new Reader();

    static class Reader implements OFMessageReader<OFCalientStatsReply> {
        @Override
        public OFCalientStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(subtype) {
               case 0x2:
                   // discriminator value 0x2L=0x2L for class OFCalientFlowStatsReplyVer13
                   return OFCalientFlowStatsReplyVer13.READER.readFrom(bb);
               case 0x1:
                   // discriminator value 0x1L=0x1L for class OFCalientPortDescStatsReplyVer13
                   return OFCalientPortDescStatsReplyVer13.READER.readFrom(bb);
               case 0x3:
                   // discriminator value 0x3L=0x3L for class OFCalientPortStatsReplyVer13
