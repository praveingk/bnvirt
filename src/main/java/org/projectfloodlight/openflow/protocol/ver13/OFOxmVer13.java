    ...
    static class Reader implements OFMessageReader<OFOxm<?>> {
        ...
        public OFOxm<?> readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            switch(typeLen) {
               ...
               case 0x85a06:
                   // discriminator value 0x85a06L=0x85a06L for class OFOxmOchSigidVer13
                   return OFOxmOchSigidVer13.READER.readFrom(bb);
               case (int) 0x80005a06:
                   // discriminator value 0x80005a06L=0x80005a06L for class OFOxmOchSigidBasicVer13
                   return OFOxmOchSigidBasicVer13.READER.readFrom(bb);
               case 0x85801:
                   // discriminator value 0x85801L=0x85801L for class OFOxmOchSigtypeVer13
                   return OFOxmOchSigtypeVer13.READER.readFrom(bb);
               case (int) 0x80005801:
                   // discriminator value 0x80005801L=0x80005801L for class OFOxmOchSigtypeBasicVer13
                   return OFOxmOchSigtypeBasicVer13.READER.readFrom(bb);
               case (int) 0x80004c08:
               ...
               default:
                   System.out.println("Warning: Got a wrong value of OXM Class :" + Long.toHexString(typeLen));
                   bb.readInt();
                   return null;
