...
public class OFFlowModifyStrictVer13 implements OFFlowModifyStrict {
...
//
    ...
    protected OFFlowModifyStrictVer13(long xid, U64 cookie, U64 cookieMask, TableId tableId, int idleTimeout, int hardTimeout, int priority, OFBufferId bufferId, OFPort outPort, OFGroup outGroup, Set<OFFlowModFlags> flags, Match match, List<OFInstruction> instructions) {
        if(cookie == null) {
