...
public class OFPacketOutVer13 implements OFPacketOut {
    ...
    public static long DEFAULT_XID = 0x0L;
...
//
    ...
    protected OFPacketOutVer13(long xid, OFBufferId bufferId, OFPort inPort, List<OFAction> actions, byte[] data) {
        if(bufferId == null) {
