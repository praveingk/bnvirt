...
public class OFEchoReplyVer10 implements OFEchoReply {
...
//
    ...
    protected OFEchoReplyVer10(long xid, byte[] data) {
        if(data == null) {
    ...
    public static class Builder implements OFEchoReply.Builder {
        // OF message fields
