...
public class OFPortModVer10 implements OFPortMod {
    ...
    protected MacAddress hwAddr;
    protected long config;
    protected long mask;
    protected long advertise;
//
    ...
    protected OFPortModVer10(long xid, OFPort portNo, MacAddress hwAddr, long config, long mask, long advertise) {
        if(portNo == null) {
    ...
    public static class Builder implements OFPortMod.Builder {
        // OF message fields
        protected boolean xidSet;
        protected long xid;
        protected boolean portNoSet;
        protected OFPort portNo;
        protected boolean hwAddrSet;
        protected MacAddress hwAddr;
        protected boolean configSet;
        protected long config;
        protected boolean maskSet;
        protected long mask;
        protected boolean advertiseSet;
        protected long advertise;
