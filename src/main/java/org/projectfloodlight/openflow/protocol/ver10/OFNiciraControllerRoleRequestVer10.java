...
public class OFNiciraControllerRoleRequestVer10 implements OFNiciraControllerRoleRequest {
...
//
    ...
    protected OFNiciraControllerRoleRequestVer10(long xid, OFNiciraControllerRole role) {
        if(role == null) {
