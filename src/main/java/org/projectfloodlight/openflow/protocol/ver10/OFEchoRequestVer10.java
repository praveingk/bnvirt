...
public class OFEchoRequestVer10 implements OFEchoRequest {
...
//
    ...
    protected OFEchoRequestVer10(long xid, byte[] data) {
        if(data == null) {
    ...
    public static class Builder implements OFEchoRequest.Builder {
        // OF message fields
