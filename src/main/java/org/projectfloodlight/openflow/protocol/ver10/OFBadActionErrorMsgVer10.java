...
public class OFBadActionErrorMsgVer10 implements OFBadActionErrorMsg {
...
//
    ...
    protected OFBadActionErrorMsgVer10(long xid, OFBadActionCode code, OFErrorCauseData data) {
        if(code == null) {
