...
public class OFBadRequestErrorMsgVer10 implements OFBadRequestErrorMsg {
...
//
    ...
    protected OFBadRequestErrorMsgVer10(long xid, OFBadRequestCode code, OFErrorCauseData data) {
        if(code == null) {
