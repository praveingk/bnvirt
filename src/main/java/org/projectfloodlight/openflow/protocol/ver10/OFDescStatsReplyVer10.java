...
public class OFDescStatsReplyVer10 implements OFDescStatsReply {
...
//
    ...
    protected OFDescStatsReplyVer10(long xid, Set<OFStatsReplyFlags> flags, String mfrDesc, String hwDesc, String swDesc, String serialNum, String dpDesc) {
        if(flags == null) {
...
//
    ...
    static class OFDescStatsReplyVer10Funnel implements Funnel<OFDescStatsReplyVer10> {
        ...
        public void funnel(OFDescStatsReplyVer10 message, PrimitiveSink sink) {
            ...
            sink.putString(message.mfrDesc);
            sink.putString(message.hwDesc);
            sink.putString(message.swDesc);
            sink.putString(message.serialNum);
            sink.putString(message.dpDesc);
        }
    }
