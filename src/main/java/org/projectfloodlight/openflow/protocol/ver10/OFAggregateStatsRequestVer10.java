...
public class OFAggregateStatsRequestVer10 implements OFAggregateStatsRequest {
...
//
    ...
    protected OFAggregateStatsRequestVer10(long xid, Set<OFStatsRequestFlags> flags, Match match, TableId tableId, OFPort outPort) {
        if(flags == null) {
