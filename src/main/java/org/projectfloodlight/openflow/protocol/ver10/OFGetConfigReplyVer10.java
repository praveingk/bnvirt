...
public class OFGetConfigReplyVer10 implements OFGetConfigReply {
    ...
    public final Set<OFConfigFlags> flags;
    public final int missSendLen;
//
    ...
    protected OFGetConfigReplyVer10(long xid, Set<OFConfigFlags> flags, int missSendLen) {
        if(flags == null) {
    ...
    public static class Builder implements OFGetConfigReply.Builder {
        // OF message fields
        protected boolean xidSet;
        protected long xid;
        protected boolean flagsSet;
        protected Set<OFConfigFlags> flags;
        protected boolean missSendLenSet;
        protected int missSendLen;
