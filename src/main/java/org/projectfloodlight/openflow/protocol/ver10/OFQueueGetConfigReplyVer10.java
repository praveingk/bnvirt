...
public class OFQueueGetConfigReplyVer10 implements OFQueueGetConfigReply {
    ...
    public final List<OFPacketQueue> queues;
//
    ...
    protected OFQueueGetConfigReplyVer10(long xid, OFPort port, List<OFPacketQueue> queues) {
        if(port == null) {
    ...
    public static class Builder implements OFQueueGetConfigReply.Builder {
        // OF message fields
        protected boolean xidSet;
        protected long xid;
        protected boolean portSet;
        protected OFPort port;
        protected boolean queuesSet;
