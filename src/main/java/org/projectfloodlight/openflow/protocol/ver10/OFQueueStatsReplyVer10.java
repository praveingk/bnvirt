...
public class OFQueueStatsReplyVer10 implements OFQueueStatsReply {
...
//
    ...
    protected OFQueueStatsReplyVer10(long xid, Set<OFStatsReplyFlags> flags, List<OFQueueStatsEntry> entries) {
        if(flags == null) {
