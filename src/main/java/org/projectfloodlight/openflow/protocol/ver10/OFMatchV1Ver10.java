...
public class OFMatchV1Ver10 implements OFMatchV1 {
    ...
    final static int LENGTH = 40;
        ...
        private final static OFVlanVidMatch DEFAULT_VLAN_VID = OFVlanVidMatch.NO_MASK; // Pravein: Changed to NO_MASK, since in v1.0, full mask is FFFF
...
//
    ...
    protected OFMatchV1Ver10(int wildcards, OFPort inPort, MacAddress ethSrc, MacAddress ethDst, OFVlanVidMatch vlanVid, VlanPcp vlanPcp, EthType ethType, IpDscp ipDscp, IpProtocol ipProto, IPv4Address ipv4Src, IPv4Address ipv4Dst, TransportPort tcpSrc, TransportPort tcpDst) {
        if(inPort == null) {
    ...
    public Iterable<MatchField<?>> getMatchFields() {
        ...
        System.out.println("WildCard = " +Integer.toHexString(wildcards));
...
//                        "Unsupported IP protocol for matching on destination port " + ipProto);
    ...
    public OFVersion getVersion() {
        ...
        public <F extends OFValueType<F>> Match.Builder setExact(MatchField<F> field,
            ...
            initWildcards();
            Object val = value;
            System.out.println("Setting exact match : "+ field.getName() +  " to "+ field.toString());
            switch (field.id) {
                case ETH_DST:
...
//
    ...
    static class Reader implements OFMessageReader<OFMatchV1> {
        ...
        public OFMatchV1 readFrom(ChannelBuffer bb) throws OFParseError {
            ...
            System.out.println(" wildcards "+ Integer.toHexString(wildcards));
