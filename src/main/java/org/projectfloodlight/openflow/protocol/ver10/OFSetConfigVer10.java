...
public class OFSetConfigVer10 implements OFSetConfig {
...
//
    ...
    protected OFSetConfigVer10(long xid, Set<OFConfigFlags> flags, int missSendLen) {
        if(flags == null) {
    ...
    public static class Builder implements OFSetConfig.Builder {
        // OF message fields
