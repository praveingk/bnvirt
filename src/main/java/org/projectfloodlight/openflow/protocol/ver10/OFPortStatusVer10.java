...
public class OFPortStatusVer10 implements OFPortStatus {
    ...
    public final OFPortReason reason;
    public final OFPortDesc desc;
//

    // package private constructor - used by readers, builders, and factory
    protected OFPortStatusVer10(long xid, OFPortReason reason, OFPortDesc desc) {
        if(reason == null) {
    ...
    static class Builder implements OFPortStatus.Builder {
        ...
        protected OFPortReason reason;
        protected boolean descSet;
        protected OFPortDesc desc;
