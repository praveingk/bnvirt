...
public class OFFlowRemovedVer10 implements OFFlowRemoved {
    ...
    protected long durationNsec;
    protected int idleTimeout;
    protected U64 packetCount;
    protected U64 byteCount;
//
    ...
    protected OFFlowRemovedVer10(long xid, Match match, U64 cookie, int priority, short reason, long durationSec, long durationNsec, int idleTimeout, U64 packetCount, U64 byteCount) {
        if(match == null) {
    ...
    public static class Builder implements OFFlowRemoved.Builder {
        // OF message fields
        ...
        protected short reason;
        protected boolean durationSecSet;
        protected long durationSec;
        protected boolean durationNsecSet;
        protected long durationNsec;
        protected boolean idleTimeoutSet;
        protected int idleTimeout;
        protected boolean packetCountSet;
        protected U64 packetCount;
        protected boolean byteCountSet;
        protected U64 byteCount;
