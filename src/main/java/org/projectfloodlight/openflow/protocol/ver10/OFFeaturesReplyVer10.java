...
public class OFFeaturesReplyVer10 implements OFFeaturesReply {
    ...
    public final DatapathId datapathId;
    public final long nBuffers;
    public final short nTables;
    public final Set<OFCapabilities> capabilities;
    public final Set<OFActionType> actions;
    public final List<OFPortDesc> ports;
//
    ...
    protected OFFeaturesReplyVer10(long xid, DatapathId datapathId, long nBuffers, short nTables, Set<OFCapabilities> capabilities, Set<OFActionType> actions, List<OFPortDesc> ports) {
        if(datapathId == null) {
    ...
    public static class Builder implements OFFeaturesReply.Builder {
        // OF message fields
        protected boolean xidSet;
        protected long xid;
        protected boolean datapathIdSet;
        protected DatapathId datapathId;
        protected boolean nBuffersSet;
        protected long nBuffers;
        protected boolean nTablesSet;
        protected short nTables;
        protected boolean capabilitiesSet;
        protected Set<OFCapabilities> capabilities;
        protected boolean actionsSet;
        protected Set<OFActionType> actions;
        protected boolean portsSet;
        protected List<OFPortDesc> ports;
