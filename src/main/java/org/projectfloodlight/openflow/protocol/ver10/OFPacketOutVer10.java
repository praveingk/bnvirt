...
public class OFPacketOutVer10 implements OFPacketOut {
    ...
    final static int MINIMUM_LENGTH = 16;
        ...
        protected final static List<OFAction> DEFAULT_ACTIONS = ImmutableList.<OFAction>of();
...
//
    ...
    protected OFPacketOutVer10(long xid, OFBufferId bufferId, OFPort inPort, List<OFAction> actions, byte[] data) {
        if(bufferId == null) {
    ...
    public static class Builder implements OFPacketOut.Builder {
        // OF message fields
