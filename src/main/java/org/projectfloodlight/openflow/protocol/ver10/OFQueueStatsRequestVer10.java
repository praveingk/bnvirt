...
public class OFQueueStatsRequestVer10 implements OFQueueStatsRequest {
...
//
    ...
    protected OFQueueStatsRequestVer10(long xid, Set<OFStatsRequestFlags> flags, OFPort portNo, long queueId) {
        if(flags == null) {
