...
public class OFFlowStatsRequestVer10 implements OFFlowStatsRequest {
...
//
    ...
    protected OFFlowStatsRequestVer10(long xid, Set<OFStatsRequestFlags> flags, Match match, TableId tableId, OFPort outPort) {
        if(flags == null) {
...
//
    ...
    static class Writer implements OFMessageWriter<OFFlowStatsRequestVer10> {
        ...
        public void write(ChannelBuffer bb, OFFlowStatsRequestVer10 message) {
            ...
            //Pravein : Hack, should be all FFs
            DEFAULT_OUT_PORT.write2Bytes(bb);
        }
    }
