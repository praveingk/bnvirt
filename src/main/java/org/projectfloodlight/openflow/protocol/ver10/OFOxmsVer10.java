...
public class OFOxmsVer10 implements OFOxms {
    ...
    public OFOxmOchSigid.Builder buildOchSigid() {
        throw new UnsupportedOperationException("OFOxmOchSigid not supported in version 1.0");
    }
    public OFOxmOchSigid ochSigid(CircuitSignalID value) {
        throw new UnsupportedOperationException("OFOxmOchSigid not supported in version 1.0");
    }

    public OFOxmOchSigidBasic.Builder buildOchSigidBasic() {
        throw new UnsupportedOperationException("OFOxmOchSigidBasic not supported in version 1.0");
    }
    public OFOxmOchSigidBasic ochSigidBasic(CircuitSignalID value) {
        throw new UnsupportedOperationException("OFOxmOchSigidBasic not supported in version 1.0");
    }

    public OFOxmOchSigtype.Builder buildOchSigtype() {
        throw new UnsupportedOperationException("OFOxmOchSigtype not supported in version 1.0");
    }
    public OFOxmOchSigtype ochSigtype(U8 value) {
        throw new UnsupportedOperationException("OFOxmOchSigtype not supported in version 1.0");
    }

    public OFOxmOchSigtypeBasic.Builder buildOchSigtypeBasic() {
        throw new UnsupportedOperationException("OFOxmOchSigtypeBasic not supported in version 1.0");
    }
    public OFOxmOchSigtypeBasic ochSigtypeBasic(U8 value) {
        throw new UnsupportedOperationException("OFOxmOchSigtypeBasic not supported in version 1.0");
    }
