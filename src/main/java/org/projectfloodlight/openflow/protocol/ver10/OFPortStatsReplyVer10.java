...
public class OFPortStatsReplyVer10 implements OFPortStatsReply {
...
//
    ...
    protected OFPortStatsReplyVer10(long xid, Set<OFStatsReplyFlags> flags, List<OFPortStatsEntry> entries) {
        if(flags == null) {
...
//
    ...
    static class Reader implements OFMessageReader<OFPortStatsReply> {
        ...
        public OFPortStatsReply readFrom(ChannelBuffer bb) throws OFParseError {
            System.out.println("!!!!!!!!!!!!!!Inside readFrom of OFPortStatsReply");
            ...
            System.out.println("Calling OFportstatsReply..");
            if (flags == null) {
                System.out.println("Flags are NULL!!!!");
            }
