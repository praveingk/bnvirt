...
public class OFFlowModFailedErrorMsgVer10 implements OFFlowModFailedErrorMsg {
...
//
    ...
    protected OFFlowModFailedErrorMsgVer10(long xid, OFFlowModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
