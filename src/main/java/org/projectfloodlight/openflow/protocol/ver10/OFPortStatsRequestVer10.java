...
public class OFPortStatsRequestVer10 implements OFPortStatsRequest {
...
//
    ...
    protected OFPortStatsRequestVer10(long xid, Set<OFStatsRequestFlags> flags, OFPort portNo) {
        if(flags == null) {
...
//
    ...
    static class Writer implements OFMessageWriter<OFPortStatsRequestVer10> {
        ...
        public void write(ChannelBuffer bb, OFPortStatsRequestVer10 message) {
            ...
            //Pravein : Set all port no.
            DEFAULT_PORT_NO.write2Bytes(bb);
