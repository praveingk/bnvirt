...
public class OFTableStatsReplyVer10 implements OFTableStatsReply {
...
//
    ...
    protected OFTableStatsReplyVer10(long xid, Set<OFStatsReplyFlags> flags, List<OFTableStatsEntry> entries) {
        if(flags == null) {
