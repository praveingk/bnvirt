...
public class OFNiciraControllerRoleReplyVer10 implements OFNiciraControllerRoleReply {
...
//
    ...
    protected OFNiciraControllerRoleReplyVer10(long xid, OFNiciraControllerRole role) {
        if(role == null) {
