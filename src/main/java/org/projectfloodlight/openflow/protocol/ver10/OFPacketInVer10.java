...
public class OFPacketInVer10 implements OFPacketIn {
    private static final Logger logger = LoggerFactory.getLogger(OFPacketInVer10.class);
    // version: 1.0
    final static byte WIRE_VERSION = 1;
    public final static int MINIMUM_LENGTH = 18;

        protected final static long DEFAULT_XID = 0x0L;
        protected final static OFBufferId DEFAULT_BUFFER_ID = OFBufferId.NO_BUFFER;
        protected final static int DEFAULT_TOTAL_LEN = 0x0;
        protected final static OFPort DEFAULT_IN_PORT = OFPort.ANY;
        protected final static byte[] DEFAULT_DATA = new byte[0];
...
//
    ...
    protected OFPacketInVer10(long xid, OFBufferId bufferId, int totalLen, OFPort inPort, OFPacketInReason reason, byte[] data) {
        if(bufferId == null) {
    ...
    protected static class Builder implements OFPacketIn.Builder {
        // OF message fields
        protected boolean xidSet;
        protected long xid;
        protected boolean bufferIdSet;
        protected OFBufferId bufferId;
        protected boolean totalLenSet;
        protected int totalLen;
        protected boolean inPortSet;
        protected OFPort inPort;
        protected boolean reasonSet;
        protected OFPacketInReason reason;
