...
public class OFFlowStatsReplyVer10 implements OFFlowStatsReply {
...
//
    ...
    protected OFFlowStatsReplyVer10(long xid, Set<OFStatsReplyFlags> flags, List<OFFlowStatsEntry> entries) {
        if(flags == null) {
