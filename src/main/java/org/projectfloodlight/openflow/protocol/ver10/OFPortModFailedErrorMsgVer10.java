...
public class OFPortModFailedErrorMsgVer10 implements OFPortModFailedErrorMsg {
...
//
    ...
    protected OFPortModFailedErrorMsgVer10(long xid, OFPortModFailedCode code, OFErrorCauseData data) {
        if(code == null) {
