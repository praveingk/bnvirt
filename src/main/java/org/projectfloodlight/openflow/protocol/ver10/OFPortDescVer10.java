...
public class OFPortDescVer10 implements OFPortDesc {
    ...
    // OF message fields
    protected final OFPort portNo;
    protected final MacAddress hwAddr;
    protected final String name;
    protected final Set<OFPortConfig> config;
    protected Set<OFPortState> state;
    protected final Set<OFPortFeatures> curr;
    protected final Set<OFPortFeatures> advertised;
    protected final Set<OFPortFeatures> supported;
    protected final Set<OFPortFeatures> peer;
//
    ...
    protected OFPortDescVer10(OFPort portNo, MacAddress hwAddr, String name, Set<OFPortConfig> config, Set<OFPortState> state, Set<OFPortFeatures> curr, Set<OFPortFeatures> advertised, Set<OFPortFeatures> supported, Set<OFPortFeatures> peer) {
        if(portNo == null) {
