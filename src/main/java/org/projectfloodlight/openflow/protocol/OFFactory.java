...
public interface OFFactory extends XidGenerator {
    ...
    OFCalientFlowStatsEntry.Builder buildCalientFlowStatsEntry() throws UnsupportedOperationException;
    OFCalientFlowStatsReply.Builder buildCalientFlowStatsReply() throws UnsupportedOperationException;
    OFCalientFlowStatsRequest.Builder buildCalientFlowStatsRequest() throws UnsupportedOperationException;
    OFCalientPortDescPropOptical.Builder buildCalientPortDescPropOptical() throws UnsupportedOperationException;
    OFCalientPortDescStatsEntry.Builder buildCalientPortDescStatsEntry() throws UnsupportedOperationException;
    OFCalientPortDescStatsReply.Builder buildCalientPortDescStatsReply() throws UnsupportedOperationException;
    OFCalientPortDescStatsRequest.Builder buildCalientPortDescStatsRequest() throws UnsupportedOperationException;
    OFCalientPortDescStatsRequest calientPortDescStatsRequest(Set<OFStatsRequestFlags> flags);
    OFCalientPortStatsEntry.Builder buildCalientPortStatsEntry() throws UnsupportedOperationException;
    OFCalientPortStatsReply.Builder buildCalientPortStatsReply() throws UnsupportedOperationException;
    OFCalientPortStatsRequest.Builder buildCalientPortStatsRequest() throws UnsupportedOperationException;
    OFCircuitPortStatus.Builder buildCircuitPortStatus() throws UnsupportedOperationException;
    OFCircuitPortsReply.Builder buildCircuitPortsReply() throws UnsupportedOperationException;
    OFCircuitPortsRequest.Builder buildCircuitPortsRequest() throws UnsupportedOperationException;
    OFCircuitPortsRequest circuitPortsRequest(Set<OFStatsRequestFlags> flags);
    ...
    OFPortDescPropOpticalTransport.Builder buildPortDescPropOpticalTransport() throws UnsupportedOperationException;
    ...
    OFPortOptical.Builder buildPortOptical() throws UnsupportedOperationException;
    OFPortOpticalTransportApplicationCode.Builder buildPortOpticalTransportApplicationCode() throws UnsupportedOperationException;
    OFPortOpticalTransportLayerEntry.Builder buildPortOpticalTransportLayerEntry() throws UnsupportedOperationException;
    OFPortOpticalTransportLayerStack.Builder buildPortOpticalTransportLayerStack() throws UnsupportedOperationException;
    OFPortOpticalTransportLayerStack portOpticalTransportLayerStack(int featureType, List<OFPortOpticalTransportLayerEntry> entries);
    ...
    OFOchSignalId.Builder buildOchSignalId() throws UnsupportedOperationException;
